 ...
 */
unsigned int LineSensor::getCurrentSensorValueWhenReliableSignal() {
 ...
 */
static void LineSensor::reInitTimer(long freq) {
 ...
 */
unsigned int LineSensor::getCurrentSensorValueRaw() {
 ...
 * Returns the current sensor value as is, with no bias compensation.
 */
unsigned long LineSensor::getBias() {
  return bias;
}
 ...
 */
static void LineSensor::updateAllInitialisedSensors() {
 ...
 */
LineSensor* LineSensor::getRightSensor() {
  return rightSensor;
}

LineSensor* LineSensor::getCentreSensor() {
  return centreSensor;
}

LineSensor* LineSensor::getLeftSensor() {
  return leftSensor;
}
 ...
 */
void LineSensor::setThreshold(ThresholdCallback* threshold_triggered_functionality, unsigned int ms) {
 ...
 */
void LineSensor::readCurrentValue() {
