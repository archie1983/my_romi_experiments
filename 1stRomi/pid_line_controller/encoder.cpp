 ...
 */
Encoder* Encoder::getLeftEncoder() {
  return leftEncoder;
}
 ...
 */
Encoder* Encoder::getRightEncoder() {
  return rightEncoder;
}
 ...
 * setup functions.
 */
Encoder::Encoder(void (*encoder_setup) (void)) {
  encoder_setup();
  encoder_pulse_cnt = 0;
}
 ...
 */
void Encoder::calculate_wheel_speed(int coefficient) {
  /*
